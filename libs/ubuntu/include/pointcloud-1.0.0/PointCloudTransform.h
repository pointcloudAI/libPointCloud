...
#ifndef POINTCLOUD_POINTCLOUD_TRANSFORM_H
#define POINTCLOUD_POINTCLOUD_TRANSFORM_H
...
class POINTCLOUD_EXPORT PointCloudTransform
{
public:
...
public:
  ...
  bool depthToPointCloud(const Vector<float> &distances,const Vector<float> &amplitude, XYZIPointCloudFrame &pointCloudFrame);
...
#endif // POINTCLOUD_POINTCLOUD_TRANSFORM_H
